    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-lg font-semibold text-gray-900">{service.duration} minutos</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Status and Activity */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Estado y Actividad</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
              ...
              <div>
                <label className="text-sm font-medium text-gray-500">Citas Realizadas</label>
                <div className="flex items-center mt-1">
